...
export class LeftmenuComponent implements OnInit {
  ...
  admin1 = [
    ...
    {
      name: 'Solution Board', path: 'user/admin1/solution-board-dashboard', showChild: false, child: true, icon: 'dds-icon_lightbulb__l__stroke'
    },
  ...
  internal = [
    ...
    { name: 'Subscription', path: '', showChild: false, child: false, icon: 'dds-icon_money__l__stroke' },
    {
      name: 'My Projects', path: 'user/admin1/my-project', showChild: false, child: true, icon: 'dds-icon_many_files__l__stroke'
    },
    {
    ...
    { name: 'Extended workspace ', path: '', showChild: false, child: false, icon: 'dds-icon_resize__l__stroke' },
    { name: 'Explore Solutions', path: '', showChild: false, child: false, icon: 'dds-icon_lightbulb__l__stroke' },
    { name: 'Service Request', path: 'user/internal_user/service-request', showChild: false, child: false, icon: 'dds-icon_service__l__stroke' },
    // { name: 'Announcements', path: 'user/admin1/dashboard', showChild: false, child: false, icon: 'dds-icon_lightbulb__l__stroke' },
    { name: 'Notifications', path: 'user/admin1/notifications', showChild: false, child: false, icon: 'dds-icon_lightbulb__l__stroke' }
  ...
  client = [
    ...
    {
      name: 'Solution Board', path: 'user/external_client/dashboard', showChild: false, child: true, icon: 'dds-icon_lightbulb__l__stroke'
    },
