...
export class SolutionService {
  ...
  // executeProject(processId: any) { //execute button in myProject
  //   return this.http.get(this.solution_url + '/ria/myProject/executeProject?processId=' + processId)
  // }
  ...
  uploadExcelToProjectExecution(data: any) {
    return this.http.post(this.solution_url + '/ria/myProject/uploadExcelToProjectExecution', data, {observe: 'events',reportProgress:true})
  }
  ...
  getErrorMsgByProjectID(projectID:any){ //project component -
   ...
   // http://localhost:9194/RIA_SOLUTION_BOARD/ria/myProject/getErrorMsgByProjectID?projectID=D1A7CD47-C3B6-4FCF-B484-FA159450913A
